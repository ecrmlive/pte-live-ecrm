...
func (Thread) TableName() string { return "qixi_m_app_cs_thread" }
...
func (Message) TableName() string { return "qixi_m_app_cs_message" }
...
func (Identity) TableName() string { return "qixi_m_admin_im_identity" }
