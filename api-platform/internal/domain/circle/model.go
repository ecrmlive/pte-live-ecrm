...
func (Circle) TableName() string { return "qixi_m_admin_circle" }

// Agent 区域或商户型商圈的代理申请与结算信息。支付账号仅由受限接口返回。
type Agent struct {
	...
	PaymentAccount        string     `gorm:"column:payment_account" json:"payment_account"`
	PaymentBank           string     `gorm:"column:payment_bank" json:"payment_bank"`
	PaymentQRImg          string     `gorm:"column:payment_qr_img" json:"payment_qr_img"`
...
func (Agent) TableName() string { return "qixi_m_admin_circle_agent" }
