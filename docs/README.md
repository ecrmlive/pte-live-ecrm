...
发布与运行约定见 [服务命名 · Docker 网络/IP](./release/SERVICE-MATRIX.md)、[发布命令](./release/COMMANDS.md) 和 [Pack/Config](./release/PACK-AND-CONFIG.md)：local/test 共用 `qixi_mergers` Docker 身份，只能切换运行。
