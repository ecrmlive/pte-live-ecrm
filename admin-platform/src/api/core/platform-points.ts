...
export function listPlatformPointsProductsApi(params: {
  ...
  return requestClient.get<{ list: PlatformPointsProduct[]; total: number; page: number; limit: number }>(
    '/points/products',
    { params },
  );
}
...
export function listPlatformPointsOrdersApi(params: {
  ...
  return requestClient.get<{ list: PlatformPointsOrder[]; total: number; page: number; limit: number }>(
    '/points/orders',
    { params },
  );
}
