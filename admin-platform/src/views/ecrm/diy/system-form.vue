...
import { fetchDiySystemForms, saveDiySystemForms } from '#/api/core/platform-maintain';
...
<template>
  <Page title="系统表单" description="系统表单 stub 列表；真实 form_builder 域待接入。">
    <EcrmListPage title="表单列表">
      <template #actions><el-button type="primary" @click="open()">新增表单</el-button></template>
    ...
    <el-dialog v-model="dialog" :title="`${editingIndex === undefined ? '新增' : '编辑'}系统表单`" width="520px" destroy-on-close>
