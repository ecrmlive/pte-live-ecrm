...
<template>
  <Page title="活动标签" description="基于 setting_cache 的 stub 配置，维护商品活动展示标签（只读列表入口，完整 CRUD 待 productmeta 扩展）。">
    <template #extra><el-button type="primary" @click="open()">新增标签</el-button></template>
    ...
    <el-dialog v-model="dialog" :title="`${editingIndex === undefined ? '新增' : '编辑'}活动标签`" width="520px" destroy-on-close>
