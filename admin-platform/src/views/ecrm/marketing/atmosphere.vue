...
import { fetchMarketingAtmosphere, saveMarketingAtmosphere } from '#/api/core/platform-marketing-cache';
const { dialog, editingIndex, form, loading, open, remove, rows, save, saving } = useCacheListCrud(fetchMarketingAtmosphere, saveMarketingAtmosphere);
</script>
<template>
  <Page title="活动氛围" description="基于 setting_cache 的 stub 配置。">
    <template #extra><el-button type="primary" @click="open()">新增氛围</el-button></template>
