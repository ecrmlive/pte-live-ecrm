...
import { fetchMarketingBorder, saveMarketingBorder } from '#/api/core/platform-marketing-cache';
const { dialog, editingIndex, form, loading, open, remove, rows, save, saving } = useCacheListCrud(fetchMarketingBorder, saveMarketingBorder);
</script>
<template>
  <Page title="活动边框" description="基于 setting_cache 的 stub 配置。">
    <template #extra><el-button type="primary" @click="open()">新增边框</el-button></template>
