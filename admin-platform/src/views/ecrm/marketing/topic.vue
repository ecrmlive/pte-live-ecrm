...
import { fetchMarketingTopic, saveMarketingTopic } from '#/api/core/platform-marketing-cache';
const { dialog, editingIndex, form, loading, open, remove, rows, save, saving } = useCacheListCrud(fetchMarketingTopic, saveMarketingTopic);
</script>
<template>
  <Page title="活动专题" description="基于 setting_cache 的 stub 配置。">
    <template #extra><el-button type="primary" @click="open()">新增专题</el-button></template>
