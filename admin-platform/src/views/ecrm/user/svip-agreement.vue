...
/** 对齐 CRMEB CacheRepository::SYS_SVIP */
const AGREE_KEY = 'sys_svip';
const PAGE_TITLE = '会员协议';
...
onMounted(async () => {
  ...
  canManage.value =
    codes.includes('user.svip.agreement.manage') ||
...
<template>
  <Page auto-content-height content-class="!p-0">
    <SettingsTabLayout v-loading="loading">
      <div class="svip-agreement">
        <div class="svip-agreement__title">{{ PAGE_TITLE }}</div>
        <VbenTiptap
          v-model="content"
          :editable="canManage"
