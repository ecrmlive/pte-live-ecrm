...
/** 对齐 CRMEB CacheRepository::EXTENSION_AGREE */
const AGREE_KEY = 'sys_extension_agree';
const PAGE_TITLE = '佣金说明';
...
onMounted(async () => {
  ...
  canManage.value =
    ...
    codes.includes('promoter.commission');
  await load();
});
</script>
  ...
  <Page auto-content-height content-class="!p-0">
    <SettingsTabLayout v-loading="loading">
      <div class="commission-desc">
        <div class="commission-desc__title">{{ PAGE_TITLE }}</div>
        <VbenTiptap
          v-model="content"
          :editable="canManage"
