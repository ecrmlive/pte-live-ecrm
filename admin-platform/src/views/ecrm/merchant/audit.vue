    ...
    <el-card class="mt-4" shadow="never">
      <el-table v-loading="loading" :data="rows" row-key="mer_intention_id">
        ...
        <el-table-column fixed="right" label="操作" width="142">
          <template #default="{ row }"><template v-if="row.status === 0"><el-button link type="primary" @click="openAudit(row, 1)">通过</el-button><el-button link type="danger" @click="openAudit(row, 2)">驳回</el-button></template><span v-else>—</span></template>
        </el-table-column>
      </el-table>
