...
defineOptions({ name: 'DiyParamsNewActivity' });
...
const schema = computed((): VbenFormSchema[] => [
  ...
  { component: 'Input', fieldName: 'style.tag_bg1', hideLabel: true, formItemClass: 'hidden' },
  { component: 'Input', fieldName: 'style.tag_bg2', hideLabel: true, formItemClass: 'hidden' },
  { component: 'Input', fieldName: 'style.tag_text_color', hideLabel: true, formItemClass: 'hidden' },
		...
		<Form class="hidden" />
			...
			<div v-if="styleType == 'style'">
				...
				<div class="form-item mult">
					...
					<div class="flex-1">
						<div class="d-s-c" style="height: 36px;">
							<DiyInputField class="ml10" v-model="curItem.style.tag_bg1" placeholder="透明" />
							<view class="ml10"><DiyColorField v-model="curItem.style.tag_bg1" default-color="#FF4C01" class="diy-inline-color" /></view>
							<component :is="PrimaryButton" link type="primary" style="margin-left: 10px;"
								 @click.stop="editor.onEditorResetColor(curItem.style, 'tag_bg1', '#FF4C01')">重置</component>
						</div>
						<div class="d-s-c" style="height: 36px;">
							<DiyInputField class="ml10" v-model="curItem.style.tag_bg2" placeholder="透明" />
							<view class="ml10"><DiyColorField v-model="curItem.style.tag_bg2" default-color="#FF4C01" class="diy-inline-color" /></view>
							<component :is="PrimaryButton" link type="primary" style="margin-left: 10px;"
								 @click.stop="editor.onEditorResetColor(curItem.style, 'tag_bg2', '#FF4C01')">重置</component>
						</div>
					</div>
				</div>
				<div class="form-item">
					...
					<div class="flex-1 d-s-c" style="height: 36px;">
						<DiyColorField v-model="curItem.style.btn_text_color" default-color="#ffffff" />
						<DiyInputField class="ml10" v-model="curItem.style.tag_text_color" placeholder="透明" />
						<component :is="PrimaryButton" link type="primary" style="margin-left: 10px;"
							 @click.stop="editor.onEditorResetColor(curItem.style, 'btn_text_color', '#fff')">重置</component>
					</div>
				</div>
				<div class="form-item">
					<div class="form-label">商品名称：</div>
