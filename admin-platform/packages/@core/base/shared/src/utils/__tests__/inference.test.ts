...
describe('isHttpUrl', () => {
  it("should return true when given 'http://qxkejiwl.top'", () => {
    expect(isHttpUrl('http://qxkejiwl.top')).toBe(true);
  });

  it("should return true when given 'https://qxkejiwl.top'", () => {
    expect(isHttpUrl('https://qxkejiwl.top')).toBe(true);
  });

  it("should return false when given 'ftp://qxkejiwl.top'", () => {
    expect(isHttpUrl('ftp://qxkejiwl.top')).toBe(false);
  });

  it("should return false when given 'qxkejiwl.top'", () => {
    expect(isHttpUrl('qxkejiwl.top')).toBe(false);
  });
});
