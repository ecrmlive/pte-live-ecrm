...
func (Category) TableName() string { return "qixi_m_admin_store_category" }
...
func (Brand) TableName() string { return "qixi_m_admin_store_brand" }
...
func (Product) TableName() string { return "qixi_m_admin_store_product" }
...
func (AttrValue) TableName() string { return "qixi_m_admin_store_product_attr_value" }
