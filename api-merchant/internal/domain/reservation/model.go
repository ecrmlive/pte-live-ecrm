...
func (Config) TableName() string { return "qixi_m_admin_store_product_reservation" }
...
func (Slot) TableName() string { return "qixi_m_admin_store_product_attr_reservation" }
