...
export function loginByAccount(account: string, password: string, captchaToken: string) {
  return http.post<LoginResult>("/auth/login", { account, password, captcha_token: captchaToken, channel: "pc" }, false);
}
