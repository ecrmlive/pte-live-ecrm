...
<template>
  ...
  >
    <div class="cover">
      ...
      <div v-else class="cover-fallback" aria-hidden="true">暂无商品图片</div>
...
.cover-fallback { width: 100%; height: 100%; display: grid; place-content: center; color: #999; background: #f4f4f4; }
