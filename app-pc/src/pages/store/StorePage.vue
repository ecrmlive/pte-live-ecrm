    ...
    <div class="pc-container store-content">
      <aside class="store-side">
        <section class="store-profile">
          ...
          <RouterLink class="service-btn" :to="`/customer-service?mer_id=${merId}`">咨询客服</RouterLink>
        </section>
