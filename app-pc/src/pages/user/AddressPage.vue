...
<template>
  <AccountFrame>
    ...
    <header class="address-header"><h1>地址管理</h1></header>
...
<style scoped>
.address-header { display: flex; align-items: center; height: 74px; border-bottom: 1px solid #eee; }.address-header h1 { margin: 0; font-size: 20px; font-weight: 500; }.hint { margin: 16px 0 0; color: #d9362b; }.address-grid { display: flex; flex-wrap: wrap; gap: 28px; padding-top: 54px; }.address-card, .address-create { position: relative; width: 360px; min-height: 264px; padding: 45px 56px; border: 1px solid #e7e7e7; background: #fff; text-align: left; }.address-card.default { border-color: #e7e7e7; }.default-mark { position: absolute; top: 0; right: 0; padding: 12px 20px; background: #f13728; color: #fff; font-size: 15px; }.address-card h2 { margin: 0 0 26px; font-size: 19px; font-weight: 500; }.address-card h2 span { display: block; padding: 20px 0 0; color: #333; font-size: 17px; font-weight: 400; }.address-card p { min-height: 44px; margin: 0; color: #999; font-size: 16px; line-height: 1.8; }.address-card footer { display: flex; gap: 15px; margin-top: 20px; padding-top: 16px; border-top: 1px dashed #e7e7e7; }.address-card button { border: 0; padding: 0; color: #555; background: transparent; font-size: 14px; }.address-card button:hover { color: #f13728; }.address-create { display: grid; place-content: center; justify-items: center; gap: 14px; color: #bbb; cursor: pointer; }.address-create span { font-size: 54px; line-height: 1; font-weight: 200; }.address-create:hover { border-color: #f13728; color: #f13728; }.address-empty { width: 100%; margin: 20px 0; color: #aaa; text-align: center; }.dialog-mask { position: fixed; z-index: 50; inset: 0; display: grid; place-items: center; padding: 20px; background: rgb(0 0 0 / 38%); }.address-dialog { width: min(100%, 520px); padding: 24px 28px; background: #fff; box-shadow: 0 16px 46px rgb(0 0 0 / 24%); }.address-dialog > header { display: flex; align-items: center; justify-content: space-between; padding-bottom: 18px; border-bottom: 1px solid #eee; }.address-dialog h2 { margin: 0; font-size: 18px; }.address-dialog header button { border: 0; background: transparent; color: #999; font-size: 28px; }.address-dialog > label { display: grid; gap: 7px; margin-top: 16px; color: #555; font-size: 14px; }.address-dialog input:not([type="checkbox"]), .address-dialog textarea { width: 100%; border: 1px solid #ddd; padding: 10px; outline: none; }.address-dialog textarea { min-height: 88px; resize: vertical; }.region-row { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; }.region-row label { display: grid; gap: 7px; color: #555; font-size: 14px; }.address-dialog .checkbox { display: block; }.address-dialog footer { display: flex; justify-content: flex-end; gap: 10px; margin-top: 22px; }.plain-btn { border: 1px solid #ddd; padding: 8px 16px; background: #fff; color: #666; } @media (max-width: 760px) { .address-card, .address-create { width: 100%; } }
</style>
