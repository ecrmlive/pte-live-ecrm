...
const form = reactive({ merchant_name: "", contact_name: "", contact_mobile: "", category_name: "", merchant_type: "", license_url: "" });
  ...
  <div class="apply-page">
    <section class="apply-panel pc-container">
      ...
      <form class="apply-form" @submit.prevent="submit">
        ...
        <label class="license"><b>* 营业执照</b><span><input v-model.trim="form.license_url" type="url" placeholder="请输入已上传的营业执照图片地址" /><small>支持 COS/CDN 图片地址，审核人员仅用于资质核验。</small></span></label>
