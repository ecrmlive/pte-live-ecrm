...
<style scoped>
.seckill-page { min-height: 680px; padding-bottom: 54px; background: #f5f5f5; }.seckill-hero { min-height: 182px; color: #333; background: #fff7f3 url('/demo/seckill-hero-v1.png') center / cover no-repeat; }.seckill-hero__inner { display: flex; flex-direction: column; justify-content: center; align-items: center; min-height: 182px; }.seckill-hero p { margin: 0; color: #d04a3d; letter-spacing: .30em; font-size: 11px; }.seckill-hero h1 { margin: 6px 0 4px; font-size: 36px; letter-spacing: .10em; }.seckill-hero span { color: #a66d65; font-size: 13px; }.content { margin-top: -16px; }.time-panel { display: grid; grid-template-columns: repeat(4, 1fr); overflow: hidden; border: 1px solid #eee2dc; background: #fff; box-shadow: 0 6px 18px rgb(113 70 42 / 7%); }.time-panel button { display: grid; justify-items: center; gap: 4px; min-height: 72px; border: 0; border-right: 1px solid #f1e6e1; color: #555; background: #fff; }.time-panel button:last-child { border-right: 0; }.time-panel strong { font-size: 22px; }.time-panel span { color: #999; font-size: 12px; }.time-panel button.active { color: #fff; background: #f13728; }.time-panel button.active span { color: #fff; opacity: .88; }.activity-head { display: flex; align-items: end; justify-content: space-between; margin: 22px 0 14px; }.activity-head h2 { margin: 0; color: #333; font-size: 20px; }.activity-head p, .activity-head > span { margin: 6px 0 0; color: #999; font-size: 13px; }.seckill-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 15px; }.seckill-card { overflow: hidden; background: #fff; cursor: pointer; }.cover { position: relative; aspect-ratio: 1; display: grid; place-items: center; color: #aaa; background: #f1f1f1; }.cover img { width: 100%; height: 100%; object-fit: cover; }.cover b { position: absolute; top: 10px; left: 10px; padding: 4px 7px; color: #fff; background: #f13728; font-size: 12px; }.meta { padding: 13px 14px 15px; }.shop { overflow: hidden; margin: 0 0 5px; color: #999; font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }.meta h3 { display: -webkit-box; min-height: 42px; margin: 0; overflow: hidden; color: #333; font-size: 15px; line-height: 21px; -webkit-box-orient: vertical; -webkit-line-clamp: 2; }.price { display: flex; align-items: baseline; gap: 8px; margin-top: 12px; }.price strong { color: #f13728; font-size: 22px; }.price del { color: #aaa; font-size: 12px; }.buy-line { display: flex; align-items: center; justify-content: space-between; margin-top: 14px; color: #999; font-size: 12px; }.buy-line button { border: 0; padding: 6px 10px; color: #fff; background: #f13728; font-size: 12px; }.hint { margin: 50px 0; color: #999; text-align: center; }.hint.empty { padding: 60px 0; background: #fff; }
