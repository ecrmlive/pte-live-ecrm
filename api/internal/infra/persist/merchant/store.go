...
func (s *StoreAdapter) ListMerchants(ctx context.Context, keyword string, status *int8, page, limit int) ([]merchant.Merchant, int64, error) {
	return s.Repo.ListMerchants(ctx, ListMerchantsFilter{Keyword: keyword, Status: status, Page: page, Limit: limit})
}
