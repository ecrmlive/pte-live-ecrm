...
func (ProductAssist) TableName() string { return "qixi_store_product_assist" }
...
func (AssistSet) TableName() string { return "qixi_store_product_assist_set" }
...
func (AssistUser) TableName() string { return "qixi_store_product_assist_user" }
