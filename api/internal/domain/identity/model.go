...
func (SystemAdmin) TableName() string { return "qixi_system_admin" }
...
func (MerchantAdmin) TableName() string { return "qixi_merchant_admin" }
...
func (Merchant) TableName() string { return "qixi_merchant" }
...
func (User) TableName() string { return "qixi_user" }
...
func (StoreService) TableName() string { return "qixi_store_service" }
...
func (SystemRole) TableName() string { return "qixi_system_role" }
...
func (SystemMenu) TableName() string { return "qixi_system_menu" }
