...
func (GroupOrder) TableName() string { return "qixi_store_group_order" }
...
func (StoreOrder) TableName() string { return "qixi_store_order" }
...
func (OrderProduct) TableName() string { return "qixi_store_order_product" }
...
// UserBill 积分/资金流水（表 qixi_user_bill）
