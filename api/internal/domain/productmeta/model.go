...
func (Label) TableName() string { return "qixi_store_product_label" }
...
func (Guarantee) TableName() string { return "qixi_store_product_guarantee" }
...
func (AttrTemplate) TableName() string { return "qixi_store_product_attr_template" }
