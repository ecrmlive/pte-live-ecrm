...
func (Category) TableName() string { return "qixi_community_category" }
...
func (Topic) TableName() string { return "qixi_community_topic" }
...
func (Post) TableName() string { return "qixi_community" }
...
func (Reply) TableName() string { return "qixi_community_reply" }
