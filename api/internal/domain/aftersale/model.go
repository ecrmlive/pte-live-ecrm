...
func (RefundOrder) TableName() string { return "qixi_store_refund_order" }
...
func (RefundProduct) TableName() string { return "qixi_store_refund_product" }
...
func (RefundStatusLog) TableName() string { return "qixi_store_refund_status" }
...
func (OrderProductLine) TableName() string { return "qixi_store_order_product" }
...
func (StoreOrderBrief) TableName() string { return "qixi_store_order" }
