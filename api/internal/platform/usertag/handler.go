...
type Handler struct{ svc *usertag.Service }

func NewHandler(svc *usertag.Service) *Handler { return &Handler{svc: svc} }

func (h *Handler) Register(r gin.IRoutes) {
	r.GET("/user/labels", h.ListLabels)
	r.POST("/user/labels", h.CreateLabel)
	r.PUT("/user/labels/:id", h.UpdateLabel)
	r.DELETE("/user/labels/:id", h.DeleteLabel)

	r.GET("/user/groups", h.ListGroups)
	r.POST("/user/groups", h.CreateGroup)
	r.PUT("/user/groups/:id", h.UpdateGroup)
	r.DELETE("/user/groups/:id", h.DeleteGroup)

	r.GET("/user/:uid/labels", h.ListUserLabels)
	r.PUT("/user/:uid/labels", h.MarkUser)
}
