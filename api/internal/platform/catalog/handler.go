...
func (h *Handler) Register(r gin.IRoutes) {
	...
	r.POST("/product-categories", h.CreateCategory)
	r.PUT("/product-categories/:id", h.UpdateCategory)
	r.DELETE("/product-categories/:id", h.DeleteCategory)

	r.GET("/brands", h.ListBrands)
	r.POST("/brands", h.CreateBrand)
	r.PUT("/brands/:id", h.UpdateBrand)
	r.DELETE("/brands/:id", h.DeleteBrand)

	r.GET("/products", h.ListProducts)
	r.GET("/products/:id", h.GetProduct)
	r.POST("/products/:id/audit", h.AuditProduct)
}
