...
PREPARE qixi_stmt FROM @qixi_ddl; EXECUTE qixi_stmt; DEALLOCATE PREPARE qixi_stmt;
-- 商户转账申请（平台监管投影，对齐 CRMEB eb_financial type=0）
...
CREATE TABLE IF NOT EXISTS `qixi_crm_a_article_category` (
  ...
  `info` varchar(255) NOT NULL DEFAULT '' COMMENT '分类说明',
  `image` varchar(1024) NOT NULL DEFAULT '' COMMENT '分类图片',
