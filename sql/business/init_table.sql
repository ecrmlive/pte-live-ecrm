...
CREATE TABLE IF NOT EXISTS `qixi_crm_b_social_topic` (
  `topic_id` bigint unsigned NOT NULL AUTO_INCREMENT, `topic_name` varchar(128) NOT NULL,
  `pic` varchar(255) NOT NULL DEFAULT '' COMMENT '话题图标',
  `status` tinyint NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `qixi_crm_b_social_post` (
  ...
  `is_show` tinyint NOT NULL DEFAULT 1, `is_hot` tinyint NOT NULL DEFAULT 0, `start` tinyint NOT NULL DEFAULT 1 COMMENT '推荐星级',
  `is_type` tinyint NOT NULL DEFAULT 1 COMMENT '1图文 2短视频', `video_link` varchar(512) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `qixi_crm_b_social_reply` (
  ...
  `uid` bigint unsigned NOT NULL, `count_start` int NOT NULL DEFAULT 0, `count_reply` int NOT NULL DEFAULT 0,
  `community_id` bigint unsigned NOT NULL, `status` tinyint NOT NULL DEFAULT 1, `refusal` varchar(500) NOT NULL DEFAULT '',
  `is_del` tinyint NOT NULL DEFAULT 0, `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- 平台账单财务流水（对齐 CRMEB eb_financial_record）
