  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/product/specs.vue'),
        meta: { title: '商品参数' },
      },
      {
        path: 'config/guarantee',
        name: 'MerConfigGuarantee',
        component: () => import('@/views/config/guarantee.vue'),
        meta: { title: '服务保障' },
      },
      {
        path: 'config/freight/shippingTemplates',
        name: 'MerShippingTemplates',
        component: () => import('@/views/config/shippingTemplates.vue'),
        meta: { title: '运费模板' },
      },
      {
        path: 'order/list',
