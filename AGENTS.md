...
本文件约束在 **qixi-live-mergers** 内工作的 Agent（Cursor / Codex）。修改代码前必须先读本文档与对应 Skill。
...
文档入口：`docs/README.md`  
Skill：`.cursor/skills/qixi-live-mergers/SKILL.md`（Codex 镜像：`codex-skills/qixi-live-mergers/`）
