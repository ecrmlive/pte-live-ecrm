...
type ElCascaderSchemaProps = InstanceType<typeof ElCascaderType>['$props'];
...
export interface ComponentPropsMap {
  ...
  Cascader: ElCascaderSchemaProps;
  ...
  Space: SpaceProps;
  Switch: SwitchProps;
  Textarea: InputProps & { rows?: number };
  ...
  const components: Partial<Record<ComponentType, Component>> = {
    ...
    Textarea: withDefaultPlaceholder(
      defineComponent({
        inheritAttrs: false,
        name: 'Textarea',
        setup: (props: Recordable<any>, { attrs, expose }) => {
          const innerRef = ref();
          expose(
            new Proxy(
              {},
